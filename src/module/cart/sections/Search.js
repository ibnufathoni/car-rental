                        ...
                        <Col md={10} className="col-md-10">
                            <Form className="my-sm-4 d-block d-md-flex justify-content-around align-self-center">
                                ...
                                <FormGroup className="my-3 input-grup align-content-center justify-content-center">
                                    ...
                                    <Input type="select" id="kapasitas" className="form-select text-secondary"
                                           disabled={isSubmitted} onChange={e => setCategory(e.target.value)}>
                                ...
                                <FormGroup className="my-3 input-grup align-content-center justify-content-center">
                                    ...
                                    <Input type="select" id="harga" className="form-select text-secondary"
                                           disabled={isSubmitted} onChange={e => setPrice(e.target.value)}>
                                ...
                                <FormGroup className="my-3 input-grup align-content-center justify-content-center">
                                    ...
                                    <Input type="select" id="status" className="form-select text-secondary"
                                           disabled={isSubmitted} onChange={e => setIsRented(e.target.value)}>
                                        ...
                                        <Col md="4" className="col-md-4 m-0 p-0">
                                            <Card className="card card-result border-1" style={{width: "21rem"}}>
                                                ...
                                                <CardBody className="card-body">
                                                    ...
                                                    <CardSubtitle tag="h5"
                                                                  className="card-title fw-bold">{formatToIDR(car.price)} /
                                                        hari</CardSubtitle>
                                                    <CardText className="card-text">Lorem ipsum dolor sit amet,
                                                        consectetur adipiscing
                                                        elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                                        aliqua.</CardText>
                                                    <Button onClick={() => handleClick(car.id)}
                                                            className="btn btn-primary w-100">Pilih Mobil</Button>
                                                </CardBody>
                                            </Card>
                                        </Col>
                                    </Fragment>
